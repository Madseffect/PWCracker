...
namespace CrackKINGClient.Model
{
  public  class UserInfo
    {
        ...
        public UserInfo(string username, string entryptedPasswordBase64, byte[] entryptedPassword)
        {
            Username = username;
            EntryptedPasswordBase64 = entryptedPasswordBase64;
            EntryptedPassword = entryptedPassword;
        }
