    ...
    public class Cracking
    {
        ...
        public List<UserInfoClearText> RunCracking()
        {
            ...
            List<UserInfoClearText> result = new List<UserInfoClearText>();
            {
                ...
                {
                    String dictionaryEntry = words[index];
                    IEnumerable<UserInfoClearText> partialResult = CheckWordWithVariations(dictionaryEntry, ListUi);
